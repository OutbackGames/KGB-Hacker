    ...
    namespace CPP{
        namespace TripleX{
            ...
            class TripleX{
                ...
                void GameLoop(){
                    while(levelDifficulty <= MAX_DIFFICULTY){
                        LogicLoop();
                        std::cin.clear();
                        std::cin.ignore();
                    }
                   if(levelDifficulty >= MAX_DIFFICULTY){
                            std::cout << "\n*** Great job Veni! The Boss wants that info, you'd better get out of there real quick! ***\n";
                   }else{
                       std::cout << "\nWhaa! Veni Where are you going!? There's work to be done!\n";
                   }
                }
